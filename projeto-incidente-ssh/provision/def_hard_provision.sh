...
# Gerar chave SSH para usuário Aluno (para acesso posterior)
sudo -u Aluno mkdir -p /home/Aluno/.ssh
sudo -u Aluno chmod 700 /home/Aluno/.ssh
sudo -u Aluno ssh-keygen -t rsa -b 4096 -f /home/Aluno/.ssh/id_rsa -N ""
sudo -u Aluno cp /home/Aluno/.ssh/id_rsa.pub /home/Aluno/.ssh/authorized_keys
sudo -u Aluno chmod 600 /home/Aluno/.ssh/authorized_keys
...
echo "Usuário: Aluno (acesso via chave SSH apenas)"
echo "SSH: CONFIGURAÇÃO SEGURA"
echo "UFW: Restritivo (default deny)"
echo "Fail2ban: ATIVO com jail SSH"
echo "Chave SSH gerada em: /home/Aluno/.ssh/id_rsa"
